REGIONES_COMUNAS = {
    ...
    'Región de Valparaíso': [
        ...
        'La Ligua', 'Limache', 'Llay-Llay', 'Los Andes', 'Nogales', 'Olmué', 'Panquehue', 'Papudo', 
    ...
    'Región Metropolitana de Santiago': [
        'Alhue', 'Buin', 'Calera de Tango', 'Cerrillos', 'Cerro Navia', 'Colina', 'Conchalí', 
        ...
        'María Pinto', 'Melipilla', 'Padre Hurtado', 'Paine', 'Pedro Aguirre Cerda', 'Peñaflor', 
        ...
        'San Pedro', 'San Ramón', 'Santiago', 'Talagante', 'Tiltil', 'Vitacura', 'Ñuñoa'
    ],
    'Región del Libertador General Bernardo O\'Higgins': [
        ...
        'Peumo', 'Pichidegua', 'Pichilemu', 'Placilla', 'Pumanque', 'Quinta de Tilcoco', 'Rancagua', 
    ...
    'Región del Biobío': [
        ...
        'Contulmo', 'Coronel', 'Curanilahue', 'Florida', 'Hualqui', 'Hualpén', 'Laja', 'Lebu', 
        'Los Álamos', 'Los Ángeles', 'Lota', 'Mulchén', 'Nacimiento', 'Negrete', 'Penco', 
        'Quilaco', 'Quilleco', 'San Pedro de la Paz', 'San Rosalía', 'Santa Bárbara', 'Santa Juana', 
    ...
    'Región de Los Lagos': [
        ...
        'Dalcahue', 'Fresia', 'Frutillar', 'Futaleufú', 'Hualaihúe', 'Llanquihue', 'Los Muermos', 
        'Maullín', 'Osorno', 'Palena', 'Puerto Montt', 'Puerto Octay', 'Puerto Varas', 'Puqueldón', 
        'Purranque', 'Puyehue', 'Queilén', 'Quellón', 'Quemchi', 'Quinchao', 'Río Negro', 'San Juan de la Costa', 'San Pablo'
    ],
...
def get_all_regiones():
    """Retorna lista de todas las regiones"""
    return list(REGIONES_COMUNAS.keys())

def get_comunas_by_region(region):
    """Retorna lista de comunas de una región específica"""
    return REGIONES_COMUNAS.get(region, [])

def get_all_comunas():
    """Retorna lista de todas las comunas de Chile"""
    comunas = []
    for region_comunas in REGIONES_COMUNAS.values():
        comunas.extend(region_comunas)
